(function (global, factory) {
  ...
  (global = global || self, factory(global.ChartGeo = {}, global.Chart));
  ...
  Chart.defaults.global.elements.geoFeature = _objectSpread2({}, Chart.defaults.global.elements.rectangle, {}, defaults); // const superClass = Chart.Element.prototype;

  var GeoFeature = Chart.elements.GeoFeature = Chart.Element.extend({
  ...
  var geoDefaults = Chart.helpers.configMerge(Chart.defaults.global, defaults$1);
  var superClass = Chart.DatasetController.prototype;
  var Geo = Chart.DatasetController.extend({
  ...
  Chart.defaults.choropleth = Chart.helpers.configMerge(geoDefaults, defaults$2);
  var superClass$1 = Geo.prototype;
  var Choropleth = Chart.controllers.choropleth = Geo.extend({
  ...
  Chart.defaults.bubbleMap = Chart.helpers.configMerge(geoDefaults, defaults$3);
  var superClass$2 = Geo.prototype;
  var bubbleClass = Chart.controllers.bubble.prototype;
  var BubbleMap = Chart.controllers.bubbleMap = Geo.extend({
  ...
  var superClass$3 = Chart.Scale.prototype;
  var ProjectionScale = Chart.Scale.extend({
    ticks: [],
  ...
  Chart.scaleService.registerScaleType('projection', ProjectionScale, defaults$4);
  ...
  exports.geoDefaults = geoDefaults;
