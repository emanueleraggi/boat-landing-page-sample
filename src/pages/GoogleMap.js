...
const MapContainer = styled.div`
    ...
    grid-gap: 10px;
    height: 90vh;
    grid-template-areas: "google-map" "ship-tracker";
...
class BoatMap extends Component {
    ...
    async updateRequest() {
        const url = 'https://boat-landing-page-sample.herokuapp.com/hello';
        ...
        // if (JSON.stringify(ships) !== '{}'){
            ...
            for (let ship of ships) {
                ...
                await fetch('https://boat-landing-page-sample.herokuapp.com/users/vessles/map/latlng', requestOptions);
